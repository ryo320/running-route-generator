                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    {onOpenSettings && (
                        <button
                            ...
                            className="p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 active:scale-95 transition-all md:hidden"
                        >
                            {/* We need Settings icon here, assume it's imported or imported now */}
