        ...
        >
            ...
            <div ref={headerRef}>
                ...
                {isApproximate && (
                    <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-xl text-sm text-yellow-800">
                        <p className="font-bold mb-1">{t('distanceMismatch')}</p>
                        <p>
                            {t('distanceMismatchDesc', { distance: route.distance.toFixed(1), target: targetDistance || 0 })}
                        </p>
                    </div>
                )}
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                    {onRetrySameSettings && (
                        <button
                            ...
                            className="flex items-center justify-center gap-1 py-2 px-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-bold rounded-lg transition-colors border border-gray-200 h-auto min-h-[40px] leading-tight"
                        >
            ...
            <div className="flex justify-between items-center mb-6 p-4 bg-gray-50 rounded-xl">
                <div className="text-center">
                    <p className="text-xs text-gray-500 uppercase font-semibold">{t('totalDistance')}</p>
                    <p className="text-2xl font-bold text-gray-900">{route.distance.toFixed(2)} km</p>
                </div>
                {route.elevationGain !== undefined && (
                    <div className="text-center border-l border-gray-200 pl-4">
                        <p className="text-xs text-gray-500 uppercase font-semibold">{t('elevationGain')}</p>
